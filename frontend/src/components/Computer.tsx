...
export function Compouter(props: JSX.IntrinsicElements['group']) {
  const group = useRef<THREE.Group | null>(null)
  const { nodes, materials, animations } = useGLTF('/models/computer.glb') as GLTFResult
  const { actions } = useAnimations<THREE.AnimationClip>(animations as THREE.AnimationClip[], group);
  const typedAction = actions as GLTFActions;
  return (
