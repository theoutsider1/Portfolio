        ...
        <section className="w-full sm:flex flex-col justify-center px-4 sm:px-12 my-12">
            ...
            <div className="w-full border-y-2 border-secondary ">
                <div className="flex flex-col sm:flex-row gap-4 py-4">
                    <div className="sm:w-1/4 text-sm sm:text-base text-secondary font-thin sm:font-light">
                        2024
                    </div>
                    <div className="sm:w-2/4 sm:flex-row-2 text-sm sm:text-2xl text-secondary font-normal sm:font-bold">
                         <h4>2jobs</h4>
                        <p className="mt-2 text-sm sm:text-base">Welcome to my magical realm of web development! I’m Hatim Tagmi, 
