...
export const About: React.FC<AboutProps> = ({isMobile})=>{
    ...
    return (
        <section id="about" className="w-full h-screen flex flex-col sm:flex-row px-4 sm:px-12 sm:pt-14 gap-10">
            ...
            <div className="sm:w-1/2 flex flex-col-reverse items-center sm:flex-col gap-14 sm:gap-10">
                ...
                <div className=" w-full my-4 sm:py-12 text-secondary ">
                    <p className="text-base sm:text-lg font-roboto font-light sm:leading-loose">
